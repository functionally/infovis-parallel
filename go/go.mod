...
replace (
	...
	bitbucket.org/bwbush/infovis-parallel/go/infovis/protobuf => ./infovis/protobuf
...
require (
	...
	bitbucket.org/bwbush/infovis-parallel/go/infovis/protobuf v0.0.0-00010101000000-000000000000 // indirect
