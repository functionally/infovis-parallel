...
namespace Infovis.Protobuf {
    ...
    static InfovisReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b24SJAoJb2Zmc2V0bG9jGAggASgLMhEuSW5mb3Zpcy5Mb2NhdGlvbiKgAgoI",
            ...
            "b2NhdGlvbhIiCgd0b29sbG9jGAggASgLMhEuSW5mb3Zpcy5Mb2NhdGlvbhIk",
            "CglvZmZzZXRsb2MYCSABKAsyES5JbmZvdmlzLkxvY2F0aW9uEhEKCWRlcHJl",
            "c3NlZBgKIAEoBxIPCgdwcmVzc2VkGAsgASgHEhAKCHJlbGVhc2VkGAwgASgH",
            "Eg4KBmFuYWxvZxgNIAMoAUITqgIQSW5mb3Zpcy5Qcm90b2J1ZmIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Infovis.Protobuf.Response), global::Infovis.Protobuf.Response.Parser, new[]{ "Shown", "Message", "Hover", "Unhover", "Select", "Deselect", "Viewloc", "Toolloc", "Offsetloc", "Depressed", "Pressed", "Released", "Analog" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class Location : pb::IMessage<Location> {
    ...
    public bool Equals(Location other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(Rotw, other.Rotw)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (Rotw != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(Rotw);
  ...
  public sealed partial class Request : pb::IMessage<Request> {
    ...
    public Request(Request other) : this() {
      ...
      viewloc_ = other.viewloc_ != null ? other.viewloc_.Clone() : null;
      toolloc_ = other.toolloc_ != null ? other.toolloc_.Clone() : null;
      offsetloc_ = other.offsetloc_ != null ? other.offsetloc_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    public void MergeFrom(Request other) {
      ...
      if (other.viewloc_ != null) {
        if (viewloc_ == null) {
          Viewloc = new global::Infovis.Protobuf.Location();
        }
        Viewloc.MergeFrom(other.Viewloc);
      }
      if (other.toolloc_ != null) {
        if (toolloc_ == null) {
          Toolloc = new global::Infovis.Protobuf.Location();
        }
        Toolloc.MergeFrom(other.Toolloc);
      }
      if (other.offsetloc_ != null) {
        if (offsetloc_ == null) {
          Offsetloc = new global::Infovis.Protobuf.Location();
        }
  ...
  public sealed partial class Response : pb::IMessage<Response> {
    ...
    /// <summary>Field number for the "offsetloc" field.</summary>
    public const int OffsetlocFieldNumber = 9;
    private global::Infovis.Protobuf.Location offsetloc_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Infovis.Protobuf.Location Offsetloc {
      get { return offsetloc_; }
    ...
    public const int DepressedFieldNumber = 10;
    ...
    public const int PressedFieldNumber = 11;
    ...
    public const int ReleasedFieldNumber = 12;
