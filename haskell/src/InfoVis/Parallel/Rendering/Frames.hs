...
import InfoVis.Parallel.Types (DeltaGeometry(..), Geometry(..), Glyph(..), Identifier, Shape(..))
...
import InfoVis.Parallel.Rendering.Shapes (Mesh, arrow, cube, icosahedron, square, tube)
...
import qualified InfoVis.Parallel.Types as I (Frame)
